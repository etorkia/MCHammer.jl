...
TargetCol is used to select the output against which the other variables are analyzed for influence.
...
PeriodRange must constructed using the Dates package and use the following syntax : **dr = collect(Date(2019,1,01):Dates.Year(1):Date(2023,01,01))**
"""
